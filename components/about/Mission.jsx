...
const values = [
  {
    ...
    description:
      "We believe every story matters. Your passion is our motivation to deliver excellence.",
    color: "rose",
  },
  {
    icon: Shield,
    ...
    description:
      "Your vision, your rights. We're here to serve your creative goals, not the other way around.",
    color: "sky",
  },
  {
    icon: Award,
    ...
    description:
      "Industry-leading quality in every edit, design, and publication we deliver.",
    color: "amber",
  },
  {
    icon: Sparkles,
    title: "Innovation",
    description:
      "Embracing new technologies and methods to enhance your reach and impact.",
    color: "violet",
  },
];
    ...
    >
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <Title tag="h2" highlight="Empower" className="mb-6">
            We Empower Authors
          </Title>
          <p className="text-foreground-muted text-lg">
            Our mission is to empower authors with professional publishing
            services, ensuring their stories reach readers worldwide.
          </p>
        </div>

        <div className="relative max-w-5xl mx-auto">
          {/* The Narrative Thread - SVG Path */}
          <svg
...
const ValueNode = ({ value, index, total, scrollProgress }) => {
  ...
  // Calculate when this node should activate based on scroll
  ...
  return (
    ...
    >
      ...
      {/* Right Side (Icon Display on Desktop, or empty on odd) */}
      <motion.div
