...
const CTA = ({ cta = {} }) => {
  const subtitle =
    cta.subtitle && cta.subtitle !== "" ? cta.subtitle : ctaSection.subtitle;
  const title = cta.title && cta.title !== "" ? cta.title : ctaSection.title;
  const text = cta.text && cta.text !== "" ? cta.text : ctaSection.text;
